...
class CompositionService:
    ...
    async def compose_email(self, request: EmailComposeRequest) -> EmailComposeResponse:
        ...
        try:
            ...
            response = await ai_client.composition_response(prompt, max_tokens=1000, temperature=0.7)
    ...
    async def compose_proposal(self, request: ProposalComposeRequest) -> ProposalComposeResponse:
        ...
        try:
            ...
            # Get response from AI client
            response = await ai_client.composition_response(prompt, max_tokens=2000, temperature=0.6)
    ...
    async def _generate_alternative_subjects(self, request: EmailComposeRequest) -> List[str]:
        ...
        try:
            ...
            response = await ai_client.composition_response(prompt, max_tokens=200, temperature=0.8)
    ...
    async def _generate_email_suggestions(self, email_body: str, request: EmailComposeRequest) -> List[str]:
        ...
        try:
            ...
            response = await ai_client.composition_response(prompt, max_tokens=300, temperature=0.5)
